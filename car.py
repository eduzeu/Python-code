...
class Car(object):
    ...
    def __init__(self, make, model, mpg, tank_capacity):
        '''constructor for make, model, mpg, and tank capacity'''
        self.__make = make
        self.__model = model
        self.__mpg = mpg
...
class HybridCar(Car):  
    ...
    def __init__(self, make, model, mpg, tank_capacity, battery_kWh, miles_per_kWh):
        '''constructor for hybridCar using super to ihnerit the Car constructor'''
    ...
    def get_battery_range(self):
        ...
        battery.
        '''
        return self.__battery_kW  *bself.__miles_per_kWh
